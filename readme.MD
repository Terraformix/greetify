...
*Figure 4: Service mesh traffic visualization for CREATE requests in Kiali*
...
![Grafana dashboard showing application-specific metrics and SLOs](https://github.com/Terraformix/greetify/blob/main/grafana-3.png)
*Figure 11: Application-specific metrics and SLO tracking dashboard*
